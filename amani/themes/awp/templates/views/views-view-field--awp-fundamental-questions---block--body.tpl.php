...
<?php
    $attached_links = '<span class="fb-share-button"  data-href="'.$url.'" data-layout="icon"></span>  <a href="https://twitter.com/share" class="twitter-share-button" data-url="'.$url.'" data-count="none">Tweet</a>';
?>
